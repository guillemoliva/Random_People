...
public class MultiSelectSpinner extends Spinner implements DialogInterface.OnMultiChoiceClickListener {
    ...
    public interface OnMultipleItemsSelectedListener{
        void selectedIndices(HashMap<Integer, String> indices);
    ...
    public boolean performClick() {
        ...
        builder.setTitle(R.string.selectMovieGenre);
    ...
    public HashMap<Integer, String> getSelectedIndices() {
        HashMap<Integer, String> hashMap = new HashMap<>();
//        List<Integer> selection = new LinkedList<>();
//        List<String> selectionString = new LinkedList<>();
        for (int i = 0; i < _items.length; ++i) {
            if (mSelection[i]) {
                hashMap.put(i,_items[i]);
